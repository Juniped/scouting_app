...
class PitcherInfo extends Component {
    ...
    getTeam(){
        if (this.state.currentTeam === ""){
            this.setState({team:"", players:[], eVm:[], rawData:[],fav:"",lastSix:[], matrix:[], firstInning:[] })
            return;
        }
        ...
        .then((res) => res.json())
        .then((result) => { this.setState({team:result[0]},this.getPlayers); })
                                        ...
                                        <MediaQuery minWidth={601}>
                                            <ResponsiveContainer>
                                                <PieChart minWidth={600}>
                                                        <Pie data={this.state.eVm} dataKey="value" cx="50%" cy="50%" nameKey="name" outerRadius={100} label={this.renderLabel} >
                                                    {
